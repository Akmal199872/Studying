...
$experience = [
	'position' => ['Front End Developer', 'Web Developer / something.com', 'Graphic Designer / designsomething.com'],
...
<h5 class="w3-opacity"><b> <?php echo $experience['position'][0]; ?> </b></h5>

<h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i> <?php echo $experience['period'][0][0]; ?> <span class="w3-tag w3-teal w3-round"> <?php echo $experience['period'][0][1]; ?> </span></h6>
...
<h5 class="w3-opacity"><b> <?php echo $experience['position'][1]; ?> </b></h5>

<h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i> <?php echo $experience['period'][1][0]; ?> <?php echo $experience['period'][1][1]; ?> </h6>
...
<h5 class="w3-opacity"><b> <?php echo $experience['position'][2]; ?> </b></h5>

<h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i> <?php echo $experience['period'][2][0]; ?> <?php echo $experience['period'][2][1]; ?> </h6>
